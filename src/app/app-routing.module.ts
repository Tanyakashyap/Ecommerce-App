...
const routes: Routes = [
  ...
  {
    path: 'admin', canActivate: [AdminAuthGuardLogin], children: [
      { path: "login", component: AdminLoginComponent },
    ]
  },
  //Path/component you want to access after admin login/signin
  {
    path: 'admin', canActivate: [AdminAuthGaurdService], children: [
  ...
  //Path/component you want to access before customer(seller) login/signin
  {
    path: 'seller', children: [
      { path: "sign-in", component: SigninSignupComponent },
      { path: "sign-up", canActivate: [SellerBuyerAuthGuardLogin], component: SigninSignupComponent },
    ]
  },

  //Path/component you want to access before customer(buyer) login/signin
  {
    path: 'buyer', children: [
      { path: "sign-in", component: SigninSignupComponent },
      { path: "sign-up", canActivate: [SellerBuyerAuthGuardLogin], component: SigninSignupComponent },
  ...
  {
    path: 'seller', canActivate: [SellerAuthGaurdService], children: [
      { path: "dashboard", component: SellerDashboardComponent },
      { path: "order", component: ProductCrudComponent },
      { path: "product", component: ProductCrudComponent },
    ]
  },
  ...
  {
    path: 'buyer', canActivate: [BuyerAuthGaurdService], children: [
